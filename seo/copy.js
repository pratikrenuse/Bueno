...
export const TOOL_COPY = {
  ...
  'your-rights': {
    en: { h1: 'Where you stand when something goes wrong',
          lead: 'How long you have to act on a property problem in Spain, and whether your own policy already pays the lawyer.',
          extra: 'Neighbour damage, community decisions, tenants, deposits, building defects and hidden defects, each with the period, the article it comes from and what to gather now.' },
    no: { h1: 'Slik står du n\u00e5r noe g\u00e5r galt',
          lead: 'Hvor lang tid du har p\u00e5 deg til \u00e5 handle ved et boligproblem i Spania, og om din egen forsikring allerede betaler advokaten.',
          extra: 'Naboskader, vedtak i sameiet, leietakere, depositum, byggefeil og skjulte mangler, med frist, lovhjemmel og hva du b\u00f8r sikre n\u00e5.' },
    sv: { h1: 'S\u00e5 st\u00e5r du n\u00e4r n\u00e5got g\u00e5r fel',
          lead: 'Hur l\u00e5ng tid du har p\u00e5 dig att agera vid ett bostadsproblem i Spanien, och om din egen f\u00f6rs\u00e4kring redan betalar advokaten.',
          extra: 'Grannskador, beslut i samf\u00e4lligheten, hyresg\u00e4ster, deposition, byggfel och dolda fel, med frist, lagrum och vad du b\u00f6r samla in nu.' },
    de: { h1: 'Wo Sie stehen, wenn etwas schiefgeht',
          lead: 'Wie lange Sie Zeit haben, bei einem Immobilienproblem in Spanien zu handeln, und ob Ihre eigene Police den Anwalt bereits zahlt.',
          extra: 'Nachbarsch\u00e4den, Beschl\u00fcsse der Eigent\u00fcmergemeinschaft, Mieter, Kaution, Baum\u00e4ngel und versteckte M\u00e4ngel, mit Frist, Rechtsgrundlage und dem, was Sie jetzt sichern sollten.' },
    fr: { h1: 'O\u00f9 vous en \u00eates quand un probl\u00e8me survient',
          lead: 'De combien de temps vous disposez pour agir sur un probl\u00e8me immobilier en Espagne, et si votre propre contrat paie d\u00e9j\u00e0 l avocat.',
          extra: 'D\u00e9g\u00e2ts caus\u00e9s par un voisin, d\u00e9cisions de la copropri\u00e9t\u00e9, locataires, d\u00e9p\u00f4t de garantie, malfa\u00e7ons et vices cach\u00e9s, avec le d\u00e9lai, l article et ce qu il faut r\u00e9unir maintenant.' },
    nl: { h1: 'Hoe u ervoor staat als er iets misgaat',
          lead: 'Hoeveel tijd u heeft om te handelen bij een woningprobleem in Spanje, en of uw eigen polis de advocaat al betaalt.',
          extra: 'Schade door de buren, besluiten van de vereniging van eigenaren, huurders, borg, bouwgebreken en verborgen gebreken, met de termijn, het wetsartikel en wat u nu moet verzamelen.' },
  },
  'cost-audit': {
