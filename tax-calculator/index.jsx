...
export default function TaxCalculator() {
  ...
  if (typeof document !== 'undefined') {
    document.title = 'Spanish Property Tax Calculator | Spain 24/7';
  }
    ...
    <div className="calc-shell">
      ...
      {step === 'email' && (
        <div className="step-screen"><div className="step-inner">
          ...
          <p className="privacy-note">We will not share your email. Trusted by 2,000+ foreign property owners in Spain.</p>
        </div></div>
      )}
      ...
      {!['intro'].includes(step) && (
        <footer className="calc-footer">For guidance only. Not legal or tax advice. Consult a qualified tax professional for your specific situation. Spain 24/7.</footer>
      )}
